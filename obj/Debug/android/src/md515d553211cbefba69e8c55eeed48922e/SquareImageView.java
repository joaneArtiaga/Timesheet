package md515d553211cbefba69e8c55eeed48922e;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("NavDrawer.Helpers.SquareImageView, NavDrawer, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SquareImageView.class, __md_methods);
	}


	public SquareImageView (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == SquareImageView.class)
			mono.android.TypeManager.Activate ("NavDrawer.Helpers.SquareImageView, NavDrawer, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public SquareImageView (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == SquareImageView.class)
			mono.android.TypeManager.Activate ("NavDrawer.Helpers.SquareImageView, NavDrawer, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public SquareImageView (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == SquareImageView.class)
	...
	public SquareImageView (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == SquareImageView.class)
